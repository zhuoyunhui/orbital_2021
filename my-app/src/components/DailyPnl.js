...
function DailyPnl() {
    ...
    useEffect(() => {
        async function daily() {
            ...
            const yString = ytd.getFullYear().toString() + (ytd.getMonth() + 1).toString().padStart(2,"0") + ytd.getDate().toString().padStart(2,"0");
    ...
    return <div>Daily PnL: {(user.dailypnl).toFixed(2)}</div>
